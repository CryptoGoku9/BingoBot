...
const { Mode, startBingo } = require('../Util/Bingo');
...
module.exports = {
	...
	async run(bot, interaction) {
        ...
        const reward = interaction.member.roles.cache.has(guildDB.adminRoleID) ? interaction.options.getInteger('reward') ?? undefined : undefined

        await startBingo(interaction.channel, mode, interaction.user, { delay, reward })
